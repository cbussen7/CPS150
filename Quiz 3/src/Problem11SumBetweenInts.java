...
CPS 150 02
Quiz 3
Problem11SumBetweenInts: number number ; number

program takes in 2 integer values and calculates/prints out the sum
of all odd numbers between the 2 integers

ex1: user inputs 2, 19  - program outputs 99
...
ex6: user inputs 1, 9 - program outputs 25
 */

import java.util.Scanner;

public class Problem11SumBetweenInts {
